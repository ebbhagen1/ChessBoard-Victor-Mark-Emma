...
{
	public class RenderBoard //Klass Chessboard (När vi skapar ett objekt i Program.cs skickar vi med nummer via konstruktor
	{
		public RenderBoard(int size) //Konstruktor tar emot storleken som en parameter 
		{
